...
/**
 * @author 王诛魔 on 2016/12/27.
 * @email phyooos@163.com
 */
...
public class StepSeekBar extends View {
    ...
    private void initConfig(Context context, AttributeSet attrs) {
        ...
        mSeekbarColorNormal = typeArr.getColor(R.styleable.StepSeekbar_seekbarColorNormal, getResources().getColor(R.color.colorPrimary));
        mSeekbarColorSelected  = typeArr.getColor(R.styleable.StepSeekbar_seekbarColorSelected,getResources().getColor(R.color.colorAccent));
